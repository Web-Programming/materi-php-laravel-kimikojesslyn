...
<nav class="main-header navbar navbar-expand navbar-dark bg-dark">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <span class="dropdown-header">11 Notifications</span>
        <div class="dropdown-divider"></div>
        <a href="#" class="dropdown-item">
          <i class="fas fa-envelope mr-2"></i> 7 new messages
          <span class="float-right text-muted text-sm">34 mins</span>
        </a>
        <!-- More notif items... -->
        <div class="dropdown-divider"></div>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4 position-fixed">
  ...
  <a href="#" class="brand-link">
    <span class="brand-text font-weight-light" style="margin-left: 15px">Universitas Multi Data</span>
  </a>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('fakultas.show', 1) }}" class="nav-link">
                ...
                <p style="font-size: small">Ilmu Komputer dan Rekayasa</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('fakultas.show', 2) }}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p style="font-size: small">Ekonomi dan Bisnis</p>
              </a>
            </li>
          </ul>
        </li>
